<?
  ...
  b_help = \"Bold text: [b]text[/b]  (alt+b)\"; i_help = \"Italic text: [i]text[/i]  (alt+i)\"; u_help = \"Underline text: [u]text[/u]  (alt+u)\"; q_help = \"Paragraf text: [p]text[/p]  (alt+q)\"; c_help = \"Heading 1: [h1]Heading[/h1]  (alt+c)\"; l_help = \"Heading 2: [h2]text[/h2] (alt+l)\"; o_help = \"List: [ul]text[/ul]  (alt+o)\"; p_help = \"Insert image: [img]http://image_url[/img]  (alt+p)\"; w_help = \"Insert URL: [url]http://url[/url] or [url=http://url]URL text[/url]  (alt+w)\"; a_help = \"Close all open tags\"; s_help = \"Font color: [color=red]text[/color]  ".$language['Tip: you can also use color']."=#FF0000\"; f_help = \"Font size: [size=x-small]small text[/size]\";
  ...
  if (!isset($step))     {$News=puMyFetch("SELECT * FROM edp_pupublish WHERE ID=$id"); }
  ...
  ".puElement("form",$EDP_SELF,"post","POST").puElement("submit",$language['Preview'],"f_button","Preview")." ".puElement("submit",$language['Update'],"f_button","Update")."<br><br>
	<div align=center>
