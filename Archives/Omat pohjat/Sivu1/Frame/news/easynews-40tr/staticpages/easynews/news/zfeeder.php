...
// NB! security
if(is_dir('../../staticpages/easynews/news/')){
  require_once("../../staticpages/easynews/news/config.php");
  require_once("../../staticpages/easynews/news/includes/zfuncs.php");
} else {
...
while ($row = mysql_fetch_array($result)) {
 ...
 if($_GET['zfcategory']==$row[opmlname]) { $curropmlfile=$row[opmlbody]; }
}

if (ZF_USEOPML == 'yes') {
        if (isset($_GET['zfcategory']) && $_GET['zfcategory']!='' && isset($curropmlfile)) {
