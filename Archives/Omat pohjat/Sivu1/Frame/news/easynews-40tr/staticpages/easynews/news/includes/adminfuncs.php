...
function zfLoginFailed()
{
    ...
    echo "<tr><td height=\"59\" align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">ZFLogo</font></td></tr>";
...
{	global $zfpath;
	$data='';
        ...
        while ($row = mysql_fetch_array($result)) {
          $categf=$row[opmlname];
          if($category==$categf) {
           $data .= "<option value=\"$categf\" selected>$categf</option><br>";
          } else {
           $data .= "<option value=\"$categf\">$categf</option><br>";
          }
        }
	return $data;
}
