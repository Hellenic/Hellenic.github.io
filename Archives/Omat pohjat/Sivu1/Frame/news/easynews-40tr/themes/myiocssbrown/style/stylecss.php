...
$body_txt="#000000"; $calink="#990000"; $td_title="#442200"; $side_top="#663300";
$crumbs="#997753"; $leftsideborder="#A98763"; $h1="#602020"; $copyr="#999";
$pullquote="#A09080"; $pullquoteborder="#908070"; $tdheadbkg="#D6B58C";
$rightsidebkg="#774411"; $even="#F7F0E7"; $h1border=$tipborder="#804040";
$tdr3="#660";  $tdr5="#060"; $tipbkg=$leftsidebkg="#EBDAC6";  $feetbkg=$footerborder="#EFE1D1";
?>
...
td#title  {vertical-align: bottom; color: #49516B; background: transparent url(../images/topbg.jpg)  no-repeat top left; font-family: 'Trebuchet MS', Arial, Helvetica, Verdana, sans-serif; padding: 0.0em 7.5em; font-size: 140%; font-weight: bold; }
td#title1 {vertical-align: middle; color: #49516B; background: transparent url(../images/topbg1.jpg) top left; font-family: 'Trebuchet MS', Arial, Helvetica, Verdana, sans-serif;  font-size: 140%; font-weight: bold; }
...
tr td#crumbs {background: <?=$crumbs; ?>; font-size: 80%; border-left: 1px solid; border-color: <?=$leftsideborder; ?>;}
...
h1 {font-weight: bold; font-size: 100%; font-family: Arial, Helvetica, Verdana, sans-serif; color: <?=$h1; ?>; border-bottom: 3px solid; border-color: <?=$h1border; ?>;  margin-bottom: 0px;}
div.edit {float: center; width: 100%; border-top: 3px solid; border-color: <?=$h1border; ?>;  padding-bottom: 2px;  font-weight: bold; font-size: 80%;  font-family:  Arial, Helvetica, Verdana, sans-serif;  padding: 3px 2px; }
div.pullquote {float: right; width: 140px; color: <?=$pullquote; ?>; border: solid; border-color: <?=$pullquoteborder; ?>; border-width: 7px 0;  font-weight: bold; font-size: 1em;  font-family:  Arial, Helvetica, Verdana, sans-serif;  padding: 3px 2px; margin: 1px 7px;}
div.google    {float: right; width: 268px; color: <?=$pullquote; ?>; border: solid; border-color: <?=$pullquoteborder; ?>; border-width: 7px 0;  font-weight: bold; font-size: 1em;  font-family:  Arial, Helvetica, Verdana, sans-serif;  padding: 3px 2px; margin: 1px 7px;}
td.head {background: <?=$tdheadbkg; ?>; text-align: center; font-weight: bold;}
td.r3 {color: <?=$tdr3; ?>;}
td.r5 {color: <?=$tdr5; ?>;}
div#traveltip {border: 3px solid; border-color: <?=$tipborder; ?>; background: <?=$tipbkg; ?>; text-align: center; margin-top: 1.5em; padding: 8px; font-size: 66%;}
div#traveltipleft {border: 0px solid; border-color: <?=$tipborder; ?>; background: #FBFBFB; text-align: left; margin-top: 1.5em; padding: 8px; font-size: 66%; margin-top: 0px;}
td#feedback {text-align: center; padding: 0.2em; background: <?=$feetbkg; ?>;}
tr#footer td  {vertical-align: middle; font-size: 66%; border-top: 3px solid; border-color: <?=$footerborder; ?>;}
...
div#login  {width: 150px; border: 3px solid; border-color: <?=$tipborder; ?>; background: <?=$tipbkg; ?>; text-align: center; margin-top: 1.5em; padding: 8px; font-size: 76%; font-weight: bold; }
div#loginl {width: 150px; border: 3px solid; border-color: <?=$tipborder; ?>; background: <?=$tipbkg; ?>; text-align: left;   margin-top: 1.5em; padding: 8px; font-size: 76%; font-weight: bold; }


td#leftside          {width: 120px; background: <?=$leftsidebkg; ?>; }
td#leftside td       {border-bottom: 0px solid; border-color: <?=$leftsideborder; ?>;  padding: 0 0 1px 0.em; }
td#leftside table    {margin-top: 0px;}
td#sidelinks a       {margin: 0; display: block; text-decoration: none; padding: 2px 10px 1px 20px; font-size: 70%; color: <?= $side_top; ?>; border: 1px solid; border-color:  rgb(90%,85%,80%) rgb(60%,55%,50%) rgb(60%,55%,50%) rgb(90%,85%,80%); }
...
td#sidelinks h4      {margin: 0; padding: 0.33em 0.25em 0;  color: <?=white ?>; font-weight: bold;  font-size: 80%; border: 1px solid; border-color: <?=$crumbs; ?>; background-color: <?=$crumbs; ?>;}
