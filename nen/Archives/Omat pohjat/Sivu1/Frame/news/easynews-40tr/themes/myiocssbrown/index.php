...
if(isset($zfcategory) and !isset($zfaction)) {
 ...
 $_GET['zftemplate']="myiocontent"; include("../../staticpages/easynews/news/zfeeder.php");
 echo "</div><br />\n";
 if(!isset($zfrefresh)) {
   echo "</div><br /></td>\n
   <td valign='top' width='20'>&nbsp;&nbsp;&nbsp;</td>\n<td>\n";
   $_GET['zftemplate']="myio"; include("../../staticpages/easynews/news/zfeeder.php");
 } else {
   }
   echo "</td></tr></table>\n";
}
...
<!-- MYIO.NET -->
<table cellspacing="1">
 <tr><th colspan="2">Myio.net</th></tr>
