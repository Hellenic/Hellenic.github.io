!(function (e) {
  ...
  var n = {};
  return (
    (t.m = e), (t.c = n), (t.p = "/react-hexgrid/examples/pathfinding/"), t(0)
  );
})(
  (function (e) {
    for (var t in e)
      ...
      var p = (function (e) {
        function t(e) {
          ...
          var n = i(
            ...
            r = c.GridGenerator.hexagon(4);
          return (
            (n.state = { hexagons: r, path: { start: null, end: null } }), n
          );
        }
        return (
          a(t, e),
          u(t, [
            {
              key: "onClick",
              value: function (e, t) {
                var n = this.state.path;
                null == n.start
                  ? (n.start = t.state.hex)
                  : ((n.start = null), (n.end = null)),
                  this.setState({ path: n });
              },
            },
            {
              key: "onMouseEnter",
              value: function (e, t) {
                ...
                var a = o.map(function (e) {
                  return (
                    (e.props.className =
                      c.HexUtils.distance(i, e) < 2 ? "active" : ""),
                    (e.props.className += i.q === e.q ? " q " : ""),
                    (e.props.className += i.r === e.r ? " r " : ""),
                    (e.props.className += i.s === e.s ? " s " : ""),
                    e
                  );
                });
                this.setState({ path: r, hexagons: a });
              },
            },
            {
              key: "render",
              value: function () {
                ...
                return l.default.createElement(
                  ...
                  l.default.createElement(
                    "h2",
                    null,
                    "Pathfinding & active highlight"
                  ),
                  l.default.createElement(
                    "p",
                    null,
                    "Click a tile to start drawing a path to your cursor. Click again to cancel."
                  ),
                  l.default.createElement(
                    "p",
                    null,
                    "Hover around the board to see helper lines drawn."
                  ),
                  l.default.createElement(
                    c.HexGrid,
...
//# sourceMappingURL=main.b920ef91.js.map
