...
(function(Loader, $) {
	...
	scripts.internal = [
		{file: ROOT_PATH + "libs/Detector.js"},
		...
		{file: ROOT_PATH + "controllers/InteractionController.js"},
		{file: ROOT_PATH + "controllers/DialogController.js"},
		{file: ROOT_PATH + "models/Scene.js"},
		{file: ROOT_PATH + "models/Model.js"},
		{file: ROOT_PATH + "models/Interaction.js"},
		{file: ROOT_PATH + "utils/DemoUtils.js"}
	];
	scripts.essential = [];
	scripts.general = [];
	scripts.shaders = [];
    ...
    function loadShaders()
    {
		...
		{
    		var shaderObject = scripts.shaders.shift();

			$.get(shaderObject.file, function(data) {
				var filename = DemoUtils.getFilename(shaderObject.file);
    ...
    Loader.addShader = function(script)
    {
    	scripts.shaders.push(getScriptObject(script, undefined));
    };
	...
	Loader.setProperties = function(properties)
	{
		...
		if (settings.stats)
		{
			scripts.internal.push(getScriptObject(ROOT_PATH + "libs/Stats.js"));
		}
